# AI-02 — Prompt Library Specification

**Project:** AI Vendor Selection System  
**Dokumen:** AI-02 — Prompt Library  
**Versi:** 2.0.0  
**Tanggal:** 2026-06-11  
**Status:** Draft  
**Author:** —  
...
Dokumen ini **tidak** mendefinisikan cara orchestration memanggil prompt — itu ada di AI-01. Dokumen ini fokus pada **isi** prompt dan **mengapa** prompt dirancang demikian.
...
|---|---|---|
| AI-01 | Agent Orchestration | Konteks penggunaan prompt tiap agent |
| AI-03 | Scoring Engine | Format output JSON yang harus dihasilkan agent |
| AI-05 | RAG Specification | Query expansion prompt untuk retrieval |
| AI-06 | Qualitative Analyzer Agent | Spesifikasi prompt agent keenam |
| AI-07 | Preference Matcher Agent | Spesifikasi prompt agent ketujuh |
...
**RAG context di halaman Hasil:** Saat user membuka halaman P-05, sistem mengambil RAG context yang relevan menggunakan mekanisme retrieval yang terdefinisi di AI-05. Context ini diinjeksikan ke system prompt sebelum percakapan dimulai. Detail mekanisme injeksi ada di AI-05 section 9.
...
Query expansion digunakan oleh pipeline retrieval RAG (AI-05 section 8.2) sebelum pertanyaan user di-embed untuk pencarian. Ini adalah LLM call terpisah yang ringan — bukan agent evaluasi.
...
Format JSON output dari tiap agent adalah kontrak antara prompt dan scoring engine. AI-03 harus mengonsumsi data dalam format yang persis sama. Output Qualitative Analyzer dan Preference Matcher perlu diintegrasikan ke dalam reasoning naratif final di AI-03 section 9.
...
| 3.0.0 | 2026-06-13 | Rename dari BE-04 ke AI-02 (ADR-035); perbarui semua referensi kode dokumen: BE-03→AI-01, BE-05→AI-03, BE-08→AI-05, BE-09→AI-06, BE-10→AI-07 | — |
