# AI-05 — RAG Specification

**Project:** AI Vendor Selection System  
**Dokumen:** AI-05 — RAG (Retrieval-Augmented Generation) Specification  
**Versi:** 2.0.0  
**Tanggal:** 2026-06-13  
**Status:** Draft  
**Author:** —  
...
|---|---|---|
| AI-01 | Agent Orchestration | Pipeline ekstraksi dokumen yang diperluas untuk indexing |
| AI-02 | Prompt Library | Prompt AI Chat Panel yang mengonsumsi konteks RAG |
| AI-04 | Integration Spec (AI Engineer) | Integrasi OpenAI Embedding API dan pgvector |
...
Pipeline indexing dipicu **saat user mengupload dokumen penawaran** di P-03, bersamaan dengan proses ekstraksi field terstruktur yang sudah terdefinisi di AI-01 section 9.
...
Di halaman lain (Dashboard, P-03, P-07, P-08), RAG tidak diperlukan karena tidak ada dokumen vendor spesifik yang relevan — AI Chat Panel menggunakan context injection berbasis data terstruktur seperti yang sudah terdefinisi di AI-02 section 6.3.
...
Saat RAG context tersedia, system prompt AI Chat Panel (AI-02 section 6) diperluas dengan blok khusus:
...
Blok ini ditempatkan setelah context halaman (AI-02 section 6.3) dan sebelum riwayat percakapan.
...
- Ekstraksi field terstruktur menggunakan vision capability LLM (mengirim halaman sebagai gambar) — ini sudah terdefinisi di AI-01
...
Section integrasi Google Gemini Embedding API sudah ditambahkan di AI-04 v1.0.0 — mencakup API key management, rate limit handling, batching strategy, dan estimasi biaya per evaluasi.
...
| 3.0.0 | 2026-06-13 | Rename dari BE-08 ke AI-05 (ADR-035); perbarui semua referensi kode dokumen: BE-03→AI-01, BE-04→AI-02, BE-07→AI-04 | — |
